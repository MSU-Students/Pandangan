...
<!-- Edit modal -->
<div id="editCom" class="modal fade" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header cstm-modal-header" >
            <h4 class="modal-title"><span id="change_title">Edit Comment</span></h4>
...
<div id="delete" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title" style="text-align:center"><span>Are you sure you wanna delete this comment?</span></h4>
                <button type="button" class="close" data-dismiss="modal" style="color:white" aria-label="Close">&times;</button>
            ...
            <form >
                ...
                <div class="control-group">
                 <div align="center" class="controls">  
                      ...
                      <button name="submit" type="submit" id="yes" class="yes btn cstm-btn-navy" data-dismiss="modal">Yes</button>
