...
<?php 
// $query = "SELECT areaNum,areaName FROM areas WHERE id = $areaID";
...
?>
    ...
    <ol class="breadcrumb mrgnTop" >
            ...
            <li class="breadcrumb-item active"><strong>Area <?= $rows['areaNum']?>  - <?=$rows['areaName']?></strong></li>
     </ol>
          
     <div style="margin-bottom: 10px">
          <a  href="<?=base_url()?>ADMS/areasV" class="btn cstm-btn-red" ><i class="fa fa-arrow-left"></i> Back</a>
        ...
        <strong>Area <?= $rows['areaNum']?>  - <?=$rows['areaName']?></strong>
         </div>
         <div class="card-body" >
                     ...
                     foreach($row as $row2){
                      ...
                      ?>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?=base_url()?>ADMS/areaFolderV/<?= $rows['areaNum']?>/<?= $row2['usersFolderID']?>"><?= $row2['name'] ?></a></td> 
                                    <td align="center"><?= $totalSubfolders[$i++]?></td> 
