                        ...
                        if($i == 0)
                          ...
                          echo '<div class="carousel-item '.$active.'">
                                ...
                                $i++;    
                                    ...
                                    <a class="carousel-control-prev hov" href="#carouselExampleIndicators" role="button"
                                        data-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="sr-only">Previous</span>
                                    </a>
                                    <a class="carousel-control-next hov" href="#carouselExampleIndicators" role="button"
                                        data-slide="next">
