...
<div class="wrapper"  >
  ...
  <div class="content-wrapper" >
    ...
    <div class="content"> 
      ...
      <div class="elevation-3  mb-3" style="background-color: white">
      <?php      
        if($row1){
        echo  '<center>
          <a href="'.base_url().'/ADMS/markAllM"  class="btn cstm-btn-navy btn-md mt-4">Mark All As Opened</a>
          <button type="button"  data-toggle="modal" data-target="#deleteNotify" class="btn cstm-btn-navy btn-md mt-4">Clear All Notifications</button>
      </center>';
        }
                  ...
                  <tbody>
                      <?php
                              ...
                              if($row2['status'] == 'unopened'){
                                if($row2['category'] == 'upload'){
                                    ...
                                    if($sql4->status == 'archived')
                                      ...
                                      echo '
                                      <td class="unopened"><a class="noteID notify2 dropdown-item py-2 point" id="'.$noteID.'" style="text-decoration:none" href="'.$view.'"><strong >'.$uploader.'</strong>  uploaded a file in<br> folder <strong>'.$location.'</strong><br><span class="dateSize">'.$row2['date'].'  '.$row2['time'].'</span></a></td>
                                      ';
                                }
                                }elseif($row2['category'] == 'assign'){
                                       
                                        echo '
                                        <td class="unopened noteID" id="'.$noteID.'" ><a href="'.base_url().'ADMS/myAssignedAreaV" class="noteID notify2 dropdown-item py-2 point" id="'.$noteID.'" style="text-decoration:none" href="#">The Admin assigned <strong>you</strong> to <br> Area <strong>'.$title2.'</strong><br><span class="dateSize">'.$row2['date'].'  '.$row2['time'].'</span></a></td>
                                        ';
                                  ...
                                  echo '<td class="unopened"><a class="noteID notify2 dropdown-item py-2 point" id="'.$noteID.'" style="text-decoration:none" href="'.$view.'"><strong>'.$person.'</strong>  commented on a file from <br>folder <strong>'.$location.'</strong><br><span class="dateSize">'.$row2['date'].'  '.$row2['time'].'</span></a></td>
                                        ';
                                }elseif($row2['category'] == 'deleteAll'){
                                  echo '
                                  <td class="unopened"><a class="noteID notify2 dropdown-item py-2 point" id="'.$noteID.'" style="text-decoration:none" href="'.$link.'"><strong>'.$person.'</strong>  deleted Folder<br> <strong>'.$title.'</strong><br><span class="dateSize">'.$row2['date'].'  '.$row2['time'].'</span></a></td>
                                  ';
                                }else{
                                        echo '
                                        <td class="unopened "><a class="noteID notify2 dropdown-item py-2 point" id="'.$noteID.'" style="text-decoration:none" href="'.$link.'"><strong>'.$person.'</strong>  deleted a file from <br>Folder <strong>'.$title.'</strong><br><span class="dateSize">'.$row2['date'].'  '.$row2['time'].'</span></a></td> 
                                        ';
                                }
                          ...
                          if($row2['category'] == 'upload'){
                                      ...
                                      echo '
                                      <td class="opened"><a class="noteID notify2 dropdown-item py-2 point" id="'.$noteID.'" style="text-decoration:none" href="'.$view.'"><strong >'.$uploader.'</strong>  uploaded a file in<br> folder <strong>'.$location.'</strong><br><span class="dateSize">'.$row2['date'].'  '.$row2['time'].'</span></a></td>
                                      ';
                                }
                          }elseif($row2['category'] == 'assign'){
                                
                            echo '
                            <td class="opened noteID" ><a href="'.base_url().'ADMS/myAssignedAreaV" class="noteID notify2 dropdown-item py-2 point" id="'.$noteID.'" style="text-decoration:none" href="#">The Admin assigned <strong>you</strong> to <br> Area <strong>'.$title2.'</strong><br><span class="dateSize">'.$row2['date'].'  '.$row2['time'].'</span></a></td>
                            ';
                          }elseif($row2['category'] == 'comment'){
                            ...
                            echo '<td class="opened"><a class="noteID notify2 dropdown-item py-2 point" id="'.$noteID.'" style="text-decoration:none" href="'.$view.'"><strong>'.$person.'</strong>  commented on a file from <br>folder <strong>'.$location.'</strong><br><span class="dateSize">'.$row2['date'].'  '.$row2['time'].'</span></a></td>
                                        ';
                          }elseif($row2['category'] == 'deleteAll'){
                                echo '
                                <td class="opened"><a class="noteID notify2 dropdown-item py-2 point" id="'.$noteID.'" style="text-decoration:none" href="'.$link.'"><strong>'.$person.'</strong>  deleted Folder<br> <strong>'.$title.'</strong><br><span class="dateSize">'.$row2['date'].'  '.$row2['time'].'</span></a></td>
                                ';
                          }else{
                                      echo '
                                      <td class="opened"><a class="noteID notify2 dropdown-item py-2 point" id="'.$noteID.'" style="text-decoration:none" href="'.$link.'"><strong>'.$person.'</strong>  deleted a file from <br>Folder <strong>'.$title.'</strong><br><span class="dateSize">'.$row2['date'].'  '.$row2['time'].'</span></a></td>
                                      ';
                              }
...
<div id="deleteNotify" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h4 class="modal-title"><span>Are you sure you wanna delete all notifications?</span></h4>
