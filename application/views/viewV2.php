        ...
        <div class="content">
            ...
            <div class="container-fluid row" style="width:100%;height:100vh">
             ...
             <?php
                          ...
                          ?>
                              <div class="col-md-8 ">
                                  <span class="float-left mt-2 mb-2" style="margin-right: 5px" ><a href="<?=base_url()?>ADMS/insideSubFolderV/<?=$levelID?>/<?=$subFolderID?>/<?=$folderNum?>/<?=$areaID?>/<?=$usersFolderID?>/<?=$programID?>" class="btn btn-danger  btn-sm" style="border-radius:20px;text-align:center;">X</a></span>
